...
import { parseL5, unparse, parseL5Exp } from './L5-ast';
import { parseTE, makeProcTExp, makeTVar, makeNonEmptyTupleTExp, makeBoolTExp, makeNumTExp, makeStrTExp, makeVoidTExp } from './TExp';
import { evalParse, evalProgram } from './L5-eval';
import { parse as p, isToken, isSexpString } from "../shared/parser";


// describe('L5 Normal Parse', () => {

//     it('parse values', () => {
//         expect(bind(p(`(values 1 2)`),parseL5Exp)).to.deep.equal(makeOk(`(values 1 2)`));
//     })
// });
